...
const { loginUser, registerUser, getUsers } = require("./users");
...
describe("Given a getUsers controller", () => {
  describe("When it's invoked", () => {
    test("Then it should call json method with a list of users", async () => {
      const users = [
        {
          id: "3",
          name: "Luis",
      ...
      User.select = jest.fn().mockReturnValue(users);
